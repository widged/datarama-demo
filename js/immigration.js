...
statFns.jobs = function(rootNode, region) {
  d3.select(rootNode).html('<div id="treemap" width="500" height="400">xxxx</div>');
  ...
  var svg = d3.select(rootNode.querySelector("#treemap")).append('svg').attr("width", width).attr("height", height),
